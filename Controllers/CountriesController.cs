...
namespace MvcCountry.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CapitalCity,Language,Currency")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CapitalCity,Language,Currency")] Country country)
        {
            if (id != country.Id)
            {
                return NotFound();
